 ...
 * @author Unknown
 * @date 9/18/2022
 * @brief Performs hardware delays of variable length
 *
 ****************************************************/
...
/***************************************************************************//**
 * @brief
 *   Performs timer delay of specified milliseconds
 *
 * @param[in] ms_delay
 *  Timer delay in milliseconds.
 *
 * @details
 *   Hardware delays can be important in waiting for devices to respond
 *
 * @note
